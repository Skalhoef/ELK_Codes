...
!--------------------------------------------------------!
if (any(task == [5,180,185,188,205,300,320,330,331,600,620]).or. &
...
if (any(task == [240,241,250,270,271,280,285])) then
