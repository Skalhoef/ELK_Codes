...
if (mp_mpi) then
  ...
  write(50,'("     A → A + e_k dt,")')
  write(50,*)
  write(50,'("where dt is an infinitesimal scalar and e_k is a strain tensor")')
  write(50,*)
  write(50,'("The piezoelectric tensor is the derivative of the polarisation &
   &vector dP_i/dt, i=1...3")')
  do k=1,nstrain
    write(50,*)
    ...
    write(50,'("  length : ",G18.10)') norm2(vc(:))
  end do
  close(50)
  write(*,*)
  write(*,'("Info(piezoelt):")')
...
call writetest(380,'Piezoelectric tensor',nv=3*nstrain,tol=1.d-5,rva=pelt)
deallocate(pelt)
